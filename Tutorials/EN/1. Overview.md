...
> [!TIP]
> 1. After importing mask textures into the project, it suggests not to check the option of Generate Mip Map and not to select High Quality for Compression in their import settings.
>    
